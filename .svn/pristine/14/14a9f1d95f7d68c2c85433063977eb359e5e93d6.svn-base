...
public class MyDB {
	...
	private static final String MYSQL_USERNAME = "ccs108nicolez";
	private static final String MYSQL_PASSWORD = "facoloow";
	private static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	private static final String MYSQL_DATABASE_NAME = "c_cs108_nicolez";
